<?php
    ...
    class Product{
        ...
        public function getAllProducts(){
            $sql = "SELECT fname,lname,email FROM student order by fname";
                  $stmt = $this->db_con->prepare($sql);
                  $stmt->execute();
                        ...
                        while($rw = $stmt->fetch(PDO::FETCH_ASSOC))
                             {
                                ...
                                $btnupd = "<a class='bt  btn-primary' href='update.php?prid=" .$rw['fname']. "' >UPDATE </a>";
            ...
            public function updateProduct($prod){
                try{
                    $sql = "UPDATE student SET fname=$product_name, lname=$price, email=$category where fname = '$prod'";
                    $stmt = $this->db_con->prepare($sql);
                    $stmt->execute();
                    return 1;
                }
