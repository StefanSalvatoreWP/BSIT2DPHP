...
// Check if the item to be deleted is specified
if (isset($_GET['delete']) && isset($_SESSION['cart_items'])) {
    $index = $_GET['delete'];
    if (array_key_exists($index, $_SESSION['cart_items'])) {
        unset($_SESSION['cart_items'][$index]); // Remove the item from the cart
    ...
    <div class="container">
        ...
        <table>
            ...
            foreach ($_SESSION['cart_items'] as $index => $item) {
                ...
                echo '<td><a href="cart.php?delete=' . $index . '">Delete</a></td>'; // Add delete link
                echo '</tr>';
            }
            ?>
        </table>
