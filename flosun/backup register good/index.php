                        ...
                        <nav class="main-nav d-none d-lg-flex">
                            ...
                            <?php
                                    ...
                                    if (isset($_SESSION['user'])) {
                                        ...
                                        // Fetch the user's first name from the database using the ID
                                        $statement = $pdo->prepare("SELECT first_name FROM users WHERE id = ?");
                                        $statement->bindParam(1, $userId);
                                        $statement->execute();
                                        $result = $statement->fetch(PDO::FETCH_ASSOC);

                                        // Display the welcome message with the user's first name
                                        if ($result && isset($result['first_name'])) {
