...
<?php else: ?>
    <div class="loginContainers">
        <H1 class="loginFirst">You need to Login First!</H1>
...
<?php if ($user): ?>
    <center>
        <div class="taskContainer card-body">
        <div class="taskContainer card-body">
       ...
       <h1>Task Tracker</h1>
        <form method="POST" action="">
            <div class="mb-3">
                ...
                <input class="taskName" type="text" class="form-control" name="name" id="name" required>
                <br>
            </div>
            <div class="mb-3">
                <label for="description">Description:</label>
                <textarea class="textArea" name="description" class="form-control" id="description" required></textarea>
                <br>
            </div>
    ...
    <h2 class="taskListName">Task List</h2>
