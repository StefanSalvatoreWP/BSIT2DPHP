        ...
        public function getAllStudents() {
            ...
            if($stmt->rowCount() > 0) {
                ...
                while($rw = $stmt->fetch(PDO::FETCH_ASSOC)) {
                    $rows .= "<tr>";
                    $rows .= "<td class='tdID'>" . $rw['student_id'] . "</td>";
                    $rows .= "<td class='tdFirst'>" . $rw['first_Name'] . "</td>";
                    $rows .= "<td class='tdLast'>" . $rw['last_Name'] . "</td>";
                    $rows .= "<td class='tdAge'>" . $rw['age'] . "</td>";
                    $btndel = "<div class='deleteTrashContainer'><a class='deleteTrash' href='delete.php?student_id=" . $rw['student_id'] .  "' ><img src='./img/delete.png' alt=''/></a></div>";
                    $btnupd = "<div class='updateWritingContainer'><a class='updateInfo' href='update.php?student_id=" . $rw['student_id'] . "'><img src='./img/writing.png' alt=''/></a></div>";
